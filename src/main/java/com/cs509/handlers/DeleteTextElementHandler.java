...
public class DeleteTextElementHandler implements RequestStreamHandler {
	...
	public DeleteTextElementHandler() {
	...
	public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
		...
		try {
			...
			this.formatResponse(new Gson().toJson(dao.deleteTextElement(textID)), 200);
		} catch (Exception e) {
