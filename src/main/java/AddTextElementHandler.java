...
public class AddTextElementHandler implements RequestStreamHandler {
	...
	public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
		...
		try {
			...
			this.formatResponse(new Gson().toJson(dao.addTextElement(text, xOrient, yOrient, width, height, font, fontSize, pageID, cardID)), 200);
		} catch (Exception e) {
