...
public class DeleteImageElementHandler implements RequestStreamHandler {
	...
	public DeleteImageElementHandler() {
	...
	public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
		...
		try {
			...
			this.formatResponse(new Gson().toJson(dao.deleteImageElement(imageID)), 200);
		} catch (Exception e) {
